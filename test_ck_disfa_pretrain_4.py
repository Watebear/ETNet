...
def main(config):
    ...
    local_f1score_arr, local_acc_arr, f1score_arr, acc_arr, mean_error, failure_rate = au_detection_eval_ck_bp4d(
        AUoccur_pred_prob, local_AUoccur_pred_prob, AUoccur_actual, pred_land, GT_land, keep=[0, 1, 3, 5], actual_keep=[0, 1, 2, 4]
    )
...
if __name__ == "__main__":
    ...
    # Directories.
    parser.add_argument('--model_prefix', type=str, default='CK_DISFA_combine_2_3')
    ...
    parser.add_argument('--res_path_prefix', type=str, default='results/CK_DISFA_combine2_3/')
