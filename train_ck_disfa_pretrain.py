...
from models.jaav2_base_ck.jaanet import JaaNetv2
...
def main(config):
    ...
    for epoch in range(config.start_epoch, config.n_epochs+1):
        ...
        local_f1score_arr, local_acc_arr, f1score_arr, acc_arr, mean_error, failure_rate = au_detection_eval_ck_bp4d(
            AUoccur_pred_prob, local_AUoccur_pred_prob, AUoccur_actual, pred_land, GT_land, keep=[0, 1, 3, 5],
            actual_keep=[0, 1, 2, 4]
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument('--print_freq', type=int, default=10, help='interval of save checkpoints')
    ...
    # Model configuration.
    parser.add_argument('--freeze_jaa', type=bool, default=False, help='freeze jaanet params')
    ...
    parser.add_argumtransforment('--resume_model', type=str, default=None, help='resume from trained model')
    parser.add_argument('--task_fold', type=str, default='DISFA_combine_1_3')
    parser.add_argument('--task_log_prefix', type=str, default='./exps/CK_DISFA_combine_1_3_pretrain/')
