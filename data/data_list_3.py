...
class ImageList_3(object):
    ...
    def make_tuples(self):
        ...
        for i in range(len(self.imgs)):
            ...
            try:
                ...
                continue
            if im_id == '0' or im_id_next_1 == '0':
                continue
            else:
                tuples.append([i-1, i, i+1])
        return tuples
    ...
    def __getitem__(self, index):
        ...
        return imgs, lands[1], bioculars[1], aus[1]
...
if __name__ == "__main__":
    crop_size = 176
    path = './list/DISFA_combine_1_2'
    ds = ImageList_3(crop_size, path)
