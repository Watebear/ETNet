...
class T_net_multi_ck(nn.Module):
    def __init__(self, configs,):
        """
        Construct a MulT model.
        """
        super(T_net_multi_ck, self).__init__()
        # setting
        self.config = configs
        self.ori_dim = 512
    ...
    def init_models(self):
        self.load_state_dict(torch.load(self.config.resume_model))
    ...
    def forward(self, feats, au=None):
        ...
        # cross attention
        feat_1_3 = self.trans_1_with_3(feat5, feat1, feat1)
        feat_2_3 = self.trans_1_with_3(feat5, feat2, feat2)
        feat_4_3 = self.trans_1_with_3(feat5, feat3, feat3)
        feat_5_3 = self.trans_1_with_3(feat5, feat4, feat4)
        # self attention
        feat_3_3 = self.trans_3_with_3(feat5, feat5, feat5)
        # merge
