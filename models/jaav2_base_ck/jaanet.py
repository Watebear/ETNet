...
from models.jaav2_base_ck.network import HMRegionLearning, AlignNet, LocalAttentionRefine, LocalAUNetv2, HLFeatExtractor, AUNet
...
class JaaNetv2(nn.Module):
    ...
    def forward(self, input, au=None, land=None, biocular=None):
        ...
        if self.training:
            ...
            local_aus_output = local_aus_output[..., [0, 1, 3, 5]]
