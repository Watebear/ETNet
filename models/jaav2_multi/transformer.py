...
from models.jaav2_multi.position_embedding import SinusoidalPositionalEmbedding
from models.jaav2_multi.multihead_attention import MultiheadAttention
import math
...
class TransformerEncoderLayer(nn.Module):
    """Encoder layer block.
    In the original paper each operation (tnet_multi-head attention or FFN) is
