...
class T_net_multi(nn.Module):
    def __init__(self, configs,):
        ...
        self.comb_emb_dim = self.emb_dim * 3
        ...
        # 4. Merge
        self.trans_temporal = self.get_network(self.comb_emb_dim)
    ...
    def forward(self, feats, au=None):
        ...
        # cross attention
        feat_1_2 = self.trans_cross(feat2, feat1, feat1)
        feat_2_2 = self.trans_self(feat2, feat2, feat2)
        feat_3_2 = self.trans_cross(feat2, feat3, feat3)

        # temporal attention
        feat_merge = torch.cat([feat_1_2, feat_2_2, feat_3_2], dim=2)
        feat_merge = self.trans_temporal(feat_merge).squeeze(0)
        # residual
...
if __name__ == "__main__":
    ...
    parser.add_argument('--emb_dim', type=int, default=512, help='dim of embedding')
    # path configuration
