...
from models.jaav2_feat.network import HMRegionLearning, AlignNet, LocalAttentionRefine, LocalAUNetv2, HLFeatExtractor, AUNet
...
class JaaNetv2(nn.Module):
    ...
    def forward(self, input, au=None, land=None, biocular=None):
        ...
        #aus_output =concat_au_feat.view(concat_au_feat.size(0), -1)
