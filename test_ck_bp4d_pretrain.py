...
def main(config):
    ...
    line2 = "F1 score of each au is: " \
            "au1={},  au2={},  au6={},  au7={},  au12={}, " \
            "au15={}, au17={}, au23={}, au24={}".format(
        f1score_arr[0], f1score_arr[1], f1score_arr[2], f1score_arr[3], f1score_arr[4],
        f1score_arr[5], f1score_arr[6], f1score_arr[7], f1score_arr[8])
    line3 = "Avarage F1 score is: avg={}".format(f1score_arr.mean())
    line4 = "Local F1 score of each au is: " \
            "au1={},  au2={},  au6={},  au7={},  au12={},  " \
            "au15={}, au17={}, au23={}, au24={}".format(
        local_f1score_arr[0], local_f1score_arr[1], local_f1score_arr[2], local_f1score_arr[3], local_f1score_arr[4],
        local_f1score_arr[5], local_f1score_arr[6], local_f1score_arr[7], local_f1score_arr[8])
    ...
    line7 = "Acc of each au is: " \
            "au1={},  au2={},  au6={},  au7={},  au12={}, " \
            "au15={}, au17={}, au23={}, au24={}".format(
        acc_arr[0], acc_arr[1], acc_arr[2], acc_arr[3], acc_arr[4],
        acc_arr[5], acc_arr[6], acc_arr[7], acc_arr[8])
...
if __name__ == "__main__":
    ...
    # Directories.
    parser.add_argument('--model_prefix', type=str, default='CK_BP4D_combine_2_3')
    parser.add_argument('--pretrain_prefix', type=str, default='./models/weights/BP4D_combine_2_3')
    ...
    parser.add_argument('--res_path_prefix', type=str, default='results/CK_BP4D_combine2_3/')
