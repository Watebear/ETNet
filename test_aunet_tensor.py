...
if __name__ == "__main__":
    ...
    parser.add_argument('--pretrain_prefix', type=str, default='./models/weights/DISFA_combine_1_2')
    ...
    parser.add_argument('--res_path_prefix', type=str, default='results/single_aunet/')
    parser.add_argument('--test_tensor_prefix', type=str, default='data/tensor/DISFA_part3')
