...
from models.jaav2_multi import JaaNetv2_multi
...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_proj', default=True,
                        help='use projection to align the input dim')
    ...
    parser.add_argument('--task_log_prefix', type=str, default='./exps/jaav2_multi/')
