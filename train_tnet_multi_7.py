...
from models.tnet_multi_7 import T_net_multi_7
...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_frames', default=7, action='store_false',
                        help='use attention mask for Transformer (default: true)')
    ...
    parser.add_argument('--task_log_prefix', type=str, default='./exps/tnet_multi_tensor_512_1234567/')
    ...
    parser.add_argument('--train_tensor_prefix', type=str, default='./data/tensor_512/DISFA_combine_2_3/train')
    parser.add_argument('--test_path_prefix', type=str, default='./data/list/DISFA_part1')
    parser.add_argument('--test_tensor_prefix', type=str, default='./data/tensor_512/DISFA_combine_2_3/test')
