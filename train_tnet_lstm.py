...
from models.tnet_lstm import TNet_lstm
...
if __name__ == "__main__":
    ...
    parser.add_argument('--bi', type=bool, default=False, help='use bi-lstm or not')
    ...
    parser.add_argument('--task_log_prefix', type=str, default='./exps/tnet_lstm/')
